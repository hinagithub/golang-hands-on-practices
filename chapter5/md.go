...
func Markdown() {
	...
	createMemubar := func() *fyne.MainMenu {
		return fyne.NewMainMenu(
			fyne.NewMenu("File",
				...
				fyne.NewMenuItem("Change", func() { cf() }),
	...
	fc := widget.NewVBox(
		tb,
		widget.NewForm(widget.NewFormItem("FIND", fnd)),
		widget.NewVBox(cbtn, wbtn, fbtn, ibtn, sbtn, xbtn),
	)
